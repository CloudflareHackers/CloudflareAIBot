...
export declare const CoreOptionsSchema: z.ZodEffects<z.ZodIntersection<z.ZodUnion<[z.ZodObject<{
    ...
    wasmBindings: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodEffects<z.ZodString, string, string>>>;
    textBlobBindings: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodEffects<z.ZodString, string, string>>>;
    dataBlobBindings: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodEffects<z.ZodString, string, string>>>;
    ...
    }>, z.ZodType<(request: Request<RequestInitCfType>, mf: Miniflare) => Awaitable<Response>, z.ZodTypeDef, (request: Request<RequestInitCfType>, mf: Miniflare) => Awaitable<Response>>]>>>;
    ...
    } | ((request: Request<RequestInitCfType>, mf: Miniflare) => Awaitable<Response>)> | undefined;
...
export declare const CoreSharedOptionsSchema: z.ZodObject<{
    ...
    unsafeModuleFallbackService: z.ZodOptional<z.ZodType<(request: Request<RequestInitCfType>, mf: Miniflare) => Awaitable<Response>, z.ZodTypeDef, (request: Request<RequestInitCfType>, mf: Miniflare) => Awaitable<Response>>>;
    ...
    unsafeModuleFallbackService?: ((request: Request<RequestInitCfType>, mf: Miniflare) => Awaitable<Response>) | undefined;
 ...
 */
export declare class DispatchFetchDispatcher extends Dispatcher {
     ...
     */
    constructor(globalDispatcher: Dispatcher, runtimeDispatcher: Dispatcher, actualRuntimeOrigin: string, userRuntimeOrigin: string, cfBlob?: IncomingRequestCfProperties);
...
export declare const PLUGIN_ENTRIES: ["cache" | "core" | "do" | "d1" | "kv" | "queues" | "r2" | "hyperdrive" | "ratelimit", ValueOf<{
